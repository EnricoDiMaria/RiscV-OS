...
#define PLIC_ENABLE   ((volatile uint32_t *)(PLIC_BASE + 0x2080)) //to enable certain interrupt or not in M-mode
#define PLIC_THRESHOLD ((volatile uint32_t *)(PLIC_BASE + 0x201000)) //to define the threshold (an interrupt with a priority under the value of
//the value defined here will be ignored)
#define PLIC_CLAIM    ((volatile uint32_t *)(PLIC_BASE + 0x201004)) //this register serves two functions:
